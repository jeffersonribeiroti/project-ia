# Mushrooms Predictor (FastAPI + Streamlit)
...
## Preparar o modelo
Se você já tem `iris_model.pkl`, coloque-o em `app_backend/model/model.joblib`.
Se NÃO tiver o modelo, rode:
   - `python scripts/train_and_save_model.py`
Isso vai treinar um  RandomForestClassifier no dataset mushrooms e salvar em `app_backend/model/model.joblib`.
